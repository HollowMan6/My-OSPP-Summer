...
- **2020.7.21-7.26** 完成Browser: Smart select text area using cursor和Browser: Mouseless browsing. [#270](https://github.com/manateelazycat/emacs-application-framework/issues/270)
...
随后设计了一个minor mode叫做`eaf-browser-caret-mode`，继续通过`M-c`开启关闭，开启时覆盖Emacs熟悉的`C-n`，`C-p`，`C-f`，`C-b`进行光标控制
